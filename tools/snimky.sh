...
#   tools/snimky.sh nazev adresa vyska [tmavy=1] [orez_vyska]
# Příklad: tools/snimky.sh sablona-minimal http://localhost:8080/ 1080
#          tools/snimky.sh sablona-minimal-tmavy http://localhost:8080/ 1080 1
